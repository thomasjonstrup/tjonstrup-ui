...
const __COMPONENT__Variants = cva(
...
const __COMPONENT__ = ({
	...
	VariantProps<typeof __COMPONENT__Variants> & {
		asChild?: boolean
	}) => {
	...
	return (
		<Comp
			data-slot="button"
			className={cn(__COMPONENT__Variants({ variant, size, className }))}
			{...props}
		/>
	)
}

export { __COMPONENT__, __COMPONENT__Variants }


/* export const __COMPONENT__: React.ComponentProps<"button"> & VariantProps<typeof buttonVariants> & {
	asChild?: boolean
} = ({ children }) => {
